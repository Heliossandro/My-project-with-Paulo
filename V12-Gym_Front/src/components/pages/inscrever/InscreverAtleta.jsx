                ...
                <A.content>
                    <A.containerForm>
                        <form >
                            ...
                            <A.line4>
                                <Input type="text" id="tipoTreino" name="tipoTreino" placeholder="Tipo de Treino"/>
                                <textarea name="desc" id="desc" cols="30" rows="10" placeholder='Descrição'></textarea>
